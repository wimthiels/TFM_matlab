clear;close all;clc;
%% Read images 
beads_relaxed_high=imread('ex3\im_beads_relaxed_BD_1.tif');
beads_stressed_high=imread('ex3\im_beads_stressed_BD_1.tif');

beads_relaxed_low=imread('ex3\im_beads_relaxed_BD_0.2.tif');
beads_stressed_low=imread('ex3\im_beads_stressed_BD_0.2.tif');
%% Display the images
