...
resXY_high = 0.39; %Resolution in um for the high stiffness gel(to be filled by student)
resXY_low = 0.35; %Resolution in um for the low stiffness gel (to be filled by student)
...
poisson =0.48 ; %Poisson ratio of the material (to be filled by student)

young_high = 4.5; %Young's modulus (in kPa) of the high stiffness gel (to be filled by student)
young_low = 1.4; %%Young's modulus (in kPa) of the low stiffness gel (to be filled by student)
